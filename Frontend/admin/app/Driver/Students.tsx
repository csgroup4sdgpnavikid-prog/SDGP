...
const styles = StyleSheet.create({
    ...
    content:      { flex: 1, backgroundColor: "#8ECAE6", borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 16 },
    summaryRow:   { flexDirection: "row", justifyContent: "space-between", marginTop: 16, gap: 12 },
    summaryCard:  { flex: 1, flexDirection: "row", alignItems: "center", borderRadius: 12, paddingVertical: 10, paddingHorizontal: 14, gap: 8 },
    summaryCount: { fontSize: 18, fontWeight: "800" },
    summaryLabel: { fontSize: 13, fontWeight: "600", color: "#374151" },
    searchSection:{ flexDirection: "row", backgroundColor: "#fff", borderRadius: 12, alignItems: "center", paddingHorizontal: 15, marginVertical: 12, height: 48 },
    searchInput:  { flex: 1, marginLeft: 10, fontSize: 14 },
    card:         { backgroundColor: "#fff", borderRadius: 14, padding: 14, flexDirection: "row", alignItems: "center", marginBottom: 12 },
    ...
    emptyText:    { textAlign: "center", marginTop: 40, color: "#374151", fontSize: 15, lineHeight: 24 },
});
